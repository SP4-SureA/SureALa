...
void SceneGraph::MoveNode(EntityBase* movingEntity, EntityBase* targetEntity)
{
	GetNode(movingEntity)->GetParent()->DetachChild(movingEntity);
	GetNode(targetEntity)->AddChild(movingEntity);
}
