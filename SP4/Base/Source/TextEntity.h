...
namespace Create
{
	TextEntity* Text2DObject(EntityManager* em, const std::string& _meshName, const Vector3& _position, const std::string& _text, const Vector3& _scale, const Color& _color);
	TextEntity* Text3DObject(EntityManager* em, const std::string& _meshName, const Vector3& _position, const std::string& _text, const Vector3& _scale, const Color& _color);
};
