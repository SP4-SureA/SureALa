...
//
//				bs.Read(id);
//				PlayerEntityBase* testy = Create::PlayerEntity(SceneManager::GetInstance()->GetScene("SceneScrolling")->GetEntityManager(), "circle", 0.0f, 0.0f, Vector3(), Vector3(3, 3, 3));
//				testy->SetID(id);
...
//						bs.Read(velY);
//						
//						q->SetServerPos(Vector3(posX, posY, 0));
//						q->SetServerVel(Vector3(velX, velY, 0));
//						q->DoInterpolation();
//
//						//bs.Read(id);
//						break;
