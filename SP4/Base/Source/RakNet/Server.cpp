...
//#include "MyMsgIDs.h"
//
//#include "..\Multiplayer_A02\Projectile.h"
//
//#include <iostream>
//
//Server::Server() :
...
//
//			itr->second->Read(bs);
//			itr->second->DoInterpolateUpdate();
//
//			bs.ResetReadPointer();
...
//
//	int objCount = 0;
//	{//count NetworkEntitys
//		if (EntityManager::GetInstance()->GetList().size() > 0)
//		{
//			for (auto q : EntityManager::GetInstance()->GetList())
//			{
...
//	bs.Reset();
//
//	Fighter* go = Create::fighter("character1", Vector3(), Vector3(3, 3, 3));
//	go->SetID(newID);
...
//}
//
//void Server::UpdatePosition(SystemAddress& addr, float x_, float y_)
//{
//	ClientMap::iterator itr = clients_.find(addr);
//	if (itr == clients_.end())
//		return;
