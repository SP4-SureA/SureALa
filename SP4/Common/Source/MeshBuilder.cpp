...
Mesh* MeshBuilder::GenerateCube(const std::string &meshName, Color color, float length)
{
	...
	//TOP FACE
	v.pos.Set(length * 0.5f, length * 0.5f, -length * 0.5f);	v.color = color;	v.normal.Set(0, 1, 0);		v.texCoord.Set(1, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(-length * 0.5f, length * 0.5f, -length * 0.5f);	v.color = color;	v.normal.Set(0, 1, 0);		v.texCoord.Set(0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(-length * 0.5f, length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(0, 1, 0);		v.texCoord.Set(0, 0);	vertex_buffer_data.push_back(v);

	v.pos.Set(length * 0.5f, length * 0.5f, -length * 0.5f);	v.color = color;	v.normal.Set(0, 1, 0);		v.texCoord.Set(1, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(-length * 0.5f, length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(0, 1, 0);		v.texCoord.Set(0, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(length * 0.5f, length * 0.5f, length * 0.5f);		v.color = color;	v.normal.Set(0, 1, 0);		v.texCoord.Set(1, 0);	vertex_buffer_data.push_back(v);
	...
	//FRONT FACE																							
	v.pos.Set(length * 0.5f, length * 0.5f, length * 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);		v.texCoord.Set(1, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(-length * 0.5f, length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(0, 0, 1);		v.texCoord.Set(0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(-length * 0.5f, -length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(0, 0, 1);		v.texCoord.Set(0, 0);	vertex_buffer_data.push_back(v);
																											
	v.pos.Set(length * 0.5f, length * 0.5f, length * 0.5f);		v.color = color;	v.normal.Set(0, 0, 1);		v.texCoord.Set(1, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(-length * 0.5f, -length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(0, 0, 1);		v.texCoord.Set(0, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(length * 0.5f, -length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(0, 0, 1);		v.texCoord.Set(1, 0);	vertex_buffer_data.push_back(v);
	...
	//RIGHT FACE																						
	v.pos.Set(length * 0.5f, length * 0.5f, -length * 0.5f);	v.color = color;	v.normal.Set(1, 0, 0);		v.texCoord.Set(1, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(length * 0.5f, length * 0.5f, length * 0.5f);		v.color = color;	v.normal.Set(1, 0, 0);		v.texCoord.Set(0, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(length * 0.5f, -length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(1, 0, 0);		v.texCoord.Set(0, 0);	vertex_buffer_data.push_back(v);

	v.pos.Set(length * 0.5f, length * 0.5f, -length * 0.5f);	v.color = color;	v.normal.Set(1, 0, 0);		v.texCoord.Set(1, 1);	vertex_buffer_data.push_back(v);
	v.pos.Set(length * 0.5f, -length * 0.5f, length * 0.5f);	v.color = color;	v.normal.Set(1, 0, 0);		v.texCoord.Set(0, 0);	vertex_buffer_data.push_back(v);
	v.pos.Set(length * 0.5f, -length * 0.5f, -length * 0.5f);	v.color = color;	v.normal.Set(1, 0, 0);		v.texCoord.Set(1, 0);	vertex_buffer_data.push_back(v);
